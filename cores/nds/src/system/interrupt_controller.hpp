...
public:
    ...
    // Sources liées aux transferts autonomes, une par canal. Elles se suivent
    // aussi, et le code qui les désigne compte dessus.
    static constexpr std::uint32_t dma_0 = 1U << 8U;

...
dependencies {
    ...
    implementation(project(":engine:save"))
    ...
    implementation(project(":features:savestates"))
    implementation(project(":features:diagnostics"))

    implementation(project(":platform:android:audio"))
    ...
    implementation(project(":platform:android:vibration"))
    implementation(project(":platform:android:lifecycle"))
